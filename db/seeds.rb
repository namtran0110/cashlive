...
Product.create store_id: user01.store.id, name: "Ukelele", price: 900000, image: File.new('seed_images/ukelele.jpg'),  description: "I'm yours"

Product.create store_id: user02.store.id, name: "Honda Wave RSX", price: 24490000, image: File.new('seed_images/wave.png'),  description: "The best wave you can ride"
Product.create store_id: user02.store.id, name: "Full Face Helmet", price: 400000, image: File.new('seed_images/fullface.jpg'),  description: "Play Safe"
Product.create store_id: user02.store.id, name: "3/4 Helmet", price: 200000, image: File.new('seed_images/threequarter.jpg'),  description: "Protection For Your Head"

Product.create store_id: user03.store.id, name: "Xoai", price: 15000, image: File.new('seed_images/xoai.jpg'),  description: "Mango Loco"
Product.create store_id: user03.store.id, name: "Dau", price: 10000, image: File.new('seed_images/dau.jpg'),  description: "Strawberry! Honey"
Product.create store_id: user03.store.id, name: "Viet Quat", price: 10000, image: File.new('seed_images/vietquat.jpg'),  description: "Raspberry Baby!"
Product.create store_id: user03.store.id, name: "Dua", price: 20000, image: File.new('seed_images/dua.jpg'),  description: "Coco nutz"

Product.create store_id: user04.store.id, name: "WWE Belt", price:120000000, image: File.new('seed_images/wwe.jpg'), description: "The only true champion with the belt"
Product.create store_id: user04.store.id, name: "John Cena House", price:770000000, image: File.new('seed_images/cena_house.jpg'), description: "The Beautiful Condo Near The Beach"
Product.create store_id: user04.store.id, name: "U Can't See Me", price: 60000, image: File.new('seed_images/cena_hat.jpg'), description: "U Can't See Me"

Product.create store_id: user05.store.id, name: "Vespa", price:59000000, image: File.new('seed_images/vespa.jpg'), description: "Cool Bike"
Product.create store_id: user05.store.id, name: "Audi A5", price:755000000, image: File.new('seed_images/2016-audi-a5.jpg'), description: "The Best Car In The World"
Product.create store_id: user05.store.id, name: "Tesla Model X", price: 949000000, image: File.new('seed_images/2016-Tesla-Model-X-P90D.jpg'), description: "You Don't Need To Drive Anymore"

Product.create store_id: user06.store.id, name: "Hu tieu Nam Vang", price: 40000, image: File.new('seed_images/nam_vang.jpg'), description: "Hu tieu re ngon"
Product.create store_id: user06.store.id, name: "Hu tieu xuong", price: 40000, image: File.new('seed_images/hu_tieu_xuong.jpg'), description: "Hu tieu re ngon"
Product.create store_id: user06.store.id, name: "Hu tieu kho", price: 40000, image: File.new('seed_images/hu_tieu_kho.jpg'), description: "Hu tieu re ngon"

Product.create store_id: user07.store.id, name: "Rails videos", price: 1400000, image: File.new('seed_images/rails.jpg'), description: "The best tutorial course you can get"
Product.create store_id: user07.store.id, name: "Swift iOS videos", price: 1100000, image: File.new('seed_images/swift.jpg'), description: "The best tutorial course you can get"

Product.create store_id: user08.store.id, name: "3CE Mood Recipe Matte Lip Color", price: 290000, image: File.new('seed_images/3ce.jpg'), description: "Beauty Product"
Product.create store_id: user08.store.id, name: "Shiseido Rouge Rouge Lipsticks", price: 270000, image: File.new('seed_images/shiseido.jpg'), description: "Beauty Product"

Product.create store_id: user09.store.id, name: "Macbook Pro Retina", price: 27900000, image: File.new('seed_images/macbook.jpg'), description: "Designed by the best, Produced by the top, Created for the common"
Product.create store_id: user09.store.id, name: "iPhone 5", price: 1870000, image: File.new('seed_images/iphone.jpg'), description: "Designed by the best, Produced by the top, Created for the common"
Product.create store_id: user09.store.id, name: "iPod", price: 970000, image: File.new('seed_images/ipod.jpg'), description: "Designed by the best, Produced by the top, Created for the common"
